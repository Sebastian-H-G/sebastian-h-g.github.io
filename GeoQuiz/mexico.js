...
const countryMappings = {
    ...
    "Distrito Federal": ["Distrito Federal", "Ciudad de México", "CDMX"],
    ...
    "Michoacán": ["Michoacán", "Michoacán de Ocampo"],
...
let attainedScore = 0;
let completed = false;
const quizId = "18cef3ad-60b3-4b77-b697-3cd7d4c4953f"; // <-- real UUID
