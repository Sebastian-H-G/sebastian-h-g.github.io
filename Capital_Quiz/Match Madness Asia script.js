...
const capitals = [
    ...
    "Thimphu", "Bandar Seri Begawan", "Phnom Penh", "Beijing", "Nicosia",
    "Tbilisi", "New Delhi", "Jakarta", "Tehran", "Baghdad",
    "Jerusalem", "Tokyo", "Amman", "Nur-Sultan", "Kuwait City",
    "Bishkek", "Vientiane", "Beirut", "Kuala Lumpur", "Malé",
    "Ulaanbaatar", "Naypyidaw", "Kathmandu", "Pyongyang", "Muscat",
    "Islamabad", "Ramallah", "Manila", "Doha", "Riyadh",
    "Singapore", "Seoul", "Colombo", "Damascus", "Taipei",
    "Dushanbe", "Bangkok", "Dili", "Ashgabat", "Abu Dhabi",
    "Tashkent", "Hanoi", "Sana'a"
];
